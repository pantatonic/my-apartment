...
public class RoomForDashboard implements Serializable {
    ...
    public RoomForDashboard() {
    }

    public RoomForDashboard(Integer id, Integer buildingId, Integer floorSeq, String roomNo, String name, BigDecimal pricePerMonth, Integer roomStatusId, String startupElectricityMeter, String startupWaterMeter, String roomStatusText) {
        this.id = id;
    ...
    public String toString() {
        return "RoomForDashboard{" + "id=" + id + ", buildingId=" + buildingId + ", floorSeq=" + floorSeq + ", roomNo=" + roomNo + ", name=" + name + ", pricePerMonth=" + pricePerMonth + ", roomStatusId=" + roomStatusId + ", startupElectricityMeter=" + startupElectricityMeter + ", startupWaterMeter=" + startupWaterMeter + ", roomStatusText=" + roomStatusText + '}';
    }
