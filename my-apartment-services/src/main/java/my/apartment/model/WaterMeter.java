...
public class WaterMeter implements Serializable {
    ...
    public WaterMeter(Integer roomId, Integer month, Integer year, String previousMeter, String presentMeter, BigDecimal chargePerUnit, Integer usageUnit, BigDecimal value, Boolean useMinimunUnitCalculate, Date createdDate, String createdDateString, Date updatedDate, String updatedDateString) {
        this.roomId = roomId;
        this.month = month;
        this.year = year;
