...
<div class="modal fade modal-scroll" id="modal-room-pdf-receipt" tabindex="-1" role="dialog" aria-labelledby="modal-room-pdf-receipt">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="pdf-receipt-process-button" 
