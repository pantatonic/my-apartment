...
<div class="modal fade modal-scroll" id="modal-cancel-room-invoice" tabindex="-1" role="dialog" aria-labelledby="modal-cancel-room-invoice">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-danger" id="modal-building-detail-label">
                    ...
                    : 
                    <span id="invoice-display"></span>
                </h4>
            </div>
            <div class="modal-body">
                <input type="hidden" name="room_invoice_id" value="">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="cancel-invoice-process-button" 
